...
export const workshops = [
  ...
  { time: '11:45–12:30', room: 'Salla kryesore', title: 'Lightning Talks', type: 'IB-Talks', agenda: ['NEET: të rinjtë që nuk studiojnë dhe nuk punojnë, përtej etiketave — Endri Basha', 'Exposure: Building an Exposure Model for Albania — Doren Calliku', 'Homelab: Setting up a homelab — Dorian Osmani', 'AI: Inteligjenca artificiale — Për t’u konfirmuar'], speaker: null, break: false },
