...
export const natureSpeakers = [
  ...
  { name: 'Doren Calliku', role: 'Kryetar i Bordit, Illyrian Brains', topic: 'Open data dhe open-source si infrastrukturë e përbashkët: si një rrjet OJF-sh që punojnë drejt qëllimeve të përbashkëta mund të ndajë të dhëna dhe mjete teknologjike, duke e bërë punën e secilit organizëm më efikase dhe me ndikim më të madh.', initials: 'DC', linkedin: 'https://www.linkedin.com/in/pomodoren/' },
];
...
export const workshops = [
  ...
  { time: '12:30–13:30', room: 'Salla kryesore', title: 'Natyra, trashëgimia dhe diaspora', type: 'Ligjëratë', text: 'Një bisedë mbi marrëdhënien mes natyrës, përvojës së diasporës dhe formave të protestës e angazhimit qytetar.', agenda: [], speaker: null, speakers: natureSpeakers, break: false }
];
