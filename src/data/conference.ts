...
export const workshops = [
  ...
  { time: '12:30–13:30', room: 'Salla kryesore', title: 'Natyra, trashëgimia dhe diaspora', type: 'Ligjëratë', text: 'Një bisedë mbi marrëdhënien mes natyrës, përvojës së diasporës dhe formave të protestës e angazhimit qytetar.', agenda: [], speaker: null, speakers: natureSpeakers, image: 'https://commons.wikimedia.org/wiki/Special:Redirect/file/Monastery%20of%20Zv%C3%ABrnec,%20Albania.jpg?width=1000', imageAlt: 'Manastiri i Zvërnecit në Lagunën e Nartës', imageCredit: 'Pudelek (Marcin Szala) · CC BY-SA 3.0', break: false }
];
