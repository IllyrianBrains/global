...
export const workshops = [
  { time: '10:00–10:45', room: 'Salla kryesore', title: 'Projekte të Illyrian Brains', type: 'IB-Projekte', text: 'Një përmbledhje e projekteve kryesore të rrjetit — nga ku nisën te ku janë sot dhe si mund të kontribuojë komuniteti.', agenda: ['Mentoring', 'Atlas', 'Heritage'], speaker: null, break: false },
